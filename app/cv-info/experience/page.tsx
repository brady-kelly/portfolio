...
import { ArrowLeft, Calendar, Building, Download } from "lucide-react";
import { cvPath, readCvFromJsonFile } from "../../lib/json/file-utils";
import { formatDate } from "@/lib/utils";
import { CvRoot, Work } from "@/lib/json/interfaces";
import { DownloadCV } from "@/components/downLoadCv";

export default function WorkExperiencePage() {
    const parsedCv: CvRoot = readCvFromJsonFile(cvPath);
    const workExperience: Work[] = parsedCv.work;
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="relative">
                    ...
                    <div className="space-y-8">
                        {workExperience.map((job: Work, index: number) => (
